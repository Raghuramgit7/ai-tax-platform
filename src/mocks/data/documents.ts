    ...
    extractionHighlights: [
      {
        ...
        page: 1,
        boundingBox: { x: 55, y: 22.5, width: 42, height: 2.8 },
      ...
      },
      {
        ...
        page: 1,
        boundingBox: { x: 55, y: 33, width: 42, height: 2.8 },
        extractedValue: 2000,
        confidence: 88,
        colorIndex: 1,
      },
      {
        ...
        page: 1,
        boundingBox: { x: 55, y: 36.5, width: 42, height: 2.8 },
    ...
    extractionHighlights: [
      {
        ...
        page: 1,
        boundingBox: { x: 55, y: 22, width: 42, height: 2.8 },
        extractedValue: 1245,
        confidence: 99,
        colorIndex: 0,
      },
