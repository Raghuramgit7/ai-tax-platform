    ...
    extractionHighlights: [
      {
        ...
        boundingBox: { x: 58, y: 26, width: 38, height: 2.8 },
      ...
      },
      {
        ...
        boundingBox: { x: 58, y: 38, width: 38, height: 2.8 },
        extractedValue: 2000,
        confidence: 88,
        colorIndex: 1,
      },
      {
        ...
        boundingBox: { x: 58, y: 41, width: 38, height: 2.8 },
    ...
    extractionHighlights: [
      {
        ...
        boundingBox: { x: 58, y: 23.5, width: 38, height: 2.8 },
        extractedValue: 1245,
        confidence: 99,
        colorIndex: 0,
      },
