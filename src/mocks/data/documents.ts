    ...
    extractionHighlights: [
      {
        ...
        page: 1,
        boundingBox: { x: 55, y: 24, width: 42, height: 3.5 },
      ...
      },
      {
        ...
        page: 1,
        boundingBox: { x: 55, y: 35.5, width: 42, height: 3.5 },
        extractedValue: 2000,
        confidence: 88,
        colorIndex: 1,
      },
      {
        ...
        page: 1,
        boundingBox: { x: 55, y: 39.5, width: 42, height: 3.5 },
    ...
    extractionHighlights: [
      {
        ...
        page: 1,
        boundingBox: { x: 55, y: 25, width: 42, height: 3.5 },
        extractedValue: 1245,
        confidence: 99,
        colorIndex: 0,
      },
