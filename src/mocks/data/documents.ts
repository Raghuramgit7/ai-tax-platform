    ...
    extractionHighlights: [
      {
        ...
        page: 1,
        boundingBox: { x: 35, y: 22, width: 20, height: 5 },
      ...
      },
      {
        ...
        page: 1,
        boundingBox: { x: 50, y: 60, width: 15, height: 4 },
        extractedValue: 2000,
        confidence: 88,
        colorIndex: 1,
      },
      {
        ...
        page: 1,
        boundingBox: { x: 20, y: 70, width: 20, height: 5 },
    ...
    extractionHighlights: [
      {
        ...
        page: 1,
        boundingBox: { x: 40, y: 30, width: 15, height: 4 },
        extractedValue: 1245,
        confidence: 99,
        colorIndex: 0,
      },
    ...
    extractionHighlights: [
      {
        ...
        page: 1,
        boundingBox: { x: 38, y: 45, width: 18, height: 4 },
        extractedValue: 890,
        confidence: 96,
        colorIndex: 0,
      },
    ...
    extractionHighlights: [
      {
        ...
        page: 1,
        boundingBox: { x: 30, y: 55, width: 25, height: 5 },
        extractedValue: 3200,
        confidence: 62,
        colorIndex: 0,
      },
